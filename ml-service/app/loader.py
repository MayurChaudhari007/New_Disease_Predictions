...
# These paths are relative to the ml-service root where we start uvicorn
DATA_DIR = "data"
MODELS_DIR = "models"

# Symptom and disease dictionaries from services.py
...
def load_data_and_model():
    ...
    try:
        ...
        print("Successfully loaded datasets into memory.")
